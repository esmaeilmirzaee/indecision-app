  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleAddOption(option) {
      ...
      this.setState(function (obj) {
        return { options: obj.options.concat(option) };
      });
    }
  }, {
    key: 'render',
...
ReactDOM.render(React.createElement(IndecisionApp, { options: ['District Attorney', 'Supreme Court'] }), document.getElementById('app'));
